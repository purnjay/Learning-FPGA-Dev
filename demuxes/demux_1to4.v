...
demux_1to2 d1(.a(a), .sel(sel[0]), .out0(carry0), .out1(carry1));
demux_1to2 d2(.a(carry0), .sel(sel[1]), .out0(out[0]), .out1(out[1]));
demux_1to2 d3(.a(carry1), .sel(sel[1]), .out0(out[2]), .out1(out[3]));  
